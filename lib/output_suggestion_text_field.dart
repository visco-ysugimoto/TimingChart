...
class AsyncOutputSuggestionTextField extends StatefulWidget {
  final String label;
  final TextEditingController controller; // 親から渡されるコントローラー

  const AsyncOutputSuggestionTextField({
    super.key,
    required this.label,
  ...
  @override
  State<AsyncOutputSuggestionTextField> createState() =>
      _AsyncOutputSuggestionTextFieldState();
}

class _AsyncOutputSuggestionTextFieldState
    extends State<AsyncOutputSuggestionTextField> {
  ...
  void initState() {
    super.initState();
    _suggestionsFuture = loadOutputSuggestions();
    // 内部コントローラーを初期化
  ...
  @override
  void didUpdateWidget(AsyncOutputSuggestionTextField oldWidget) {
